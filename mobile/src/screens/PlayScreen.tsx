...
const styles = StyleSheet.create({
  ...
  gameTabText: { color: colors.textMuted },
  gameTabTextActive: { color: colors.text, fontWeight: '700' },
  ...
  rangeText: { color: colors.textMuted, fontSize: 13 },
